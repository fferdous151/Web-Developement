...
<tr>
<td width = "300px"></td>
<td width = "30px"><img src="../resources/admin.png" width="300" height="300"></td></a>
<td width = "10px">
...
$userQuery=$connection->getAdmin($conobj,"admindb",$admin);

echo "<fieldset><Legend> Hello Admin </Legend><br>";
...
if ($userQuery->num_rows > 0){
    ...
    echo "<br> Name: ". $row["aname"]. " <br> Email: ". $row["aemail"]. " <br>";
    }
} else {
    echo "0 results";
}
...
<?php
include('../control/adminteachercheck.php');
?>
</fieldset>
</th>
...
<p id="mytext"></p>
<br><br>
<fieldset><Legend>Find detail of teacher</Legend><br><br>
...
<br>
<br>
<center><a href="/PROJECT/view/adminaccountdelete.php">Delete your Account</a></center>
